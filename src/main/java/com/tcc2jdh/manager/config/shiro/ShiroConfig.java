package com.tcc2jdh.manager.config.shiro;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
        ...
        List<com.tcc2jdh.manager.entity.sys.Resource> list = resourceService.findAll();
        for (com.tcc2jdh.manager.entity.sys.Resource resource : list) {
