package site.chenwenlong.manager.config.shiro;
...
import site.chenwenlong.manager.service.sys.IResourceService;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
        ...
        List<site.chenwenlong.manager.entity.sys.Resource> list = resourceService.findAll();
        for (site.chenwenlong.manager.entity.sys.Resource resource : list) {
